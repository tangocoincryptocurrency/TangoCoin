...
namespace parameters {
  ...
  const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x571c; // addresses start with "TV"
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "TC-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "TC-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "TC-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "TC-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "TC-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "TC-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "TC-miner_conf.json";
  } // parameters
...
const char     CRYPTONOTE_NAME[]                             = "Tangocoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001904e029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101bdc93e7e60a7e35455d6b92d537387b825f31ddcb13df2b822d59e2acaace651";
